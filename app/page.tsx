...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden snap-y snap-mandatory h-screen overflow-y-scroll">
      ...
      <div className="relative z-10">
        {/* Hero Section */}
        <section id="hero" className="h-screen flex flex-col items-center justify-center px-4 py-20 text-center snap-start snap-always">
          <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold text-white drop-shadow-2xl mb-6" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
              <span className="block tracking-wider">EN GARDE</span>
              <span className="block text-4xl md:text-5xl lg:text-6xl mt-4 text-gray-200 tracking-wider">
                ESKRİM
              </span>
            </h1>
            <p className="text-2xl md:text-3xl lg:text-4xl text-gray-100 font-light max-w-3xl mx-auto leading-relaxed drop-shadow-lg italic tracking-wide">
              Modern teknikler, geleneksel değerler
            </p>
            <p className="text-base md:text-lg lg:text-xl text-gray-200 max-w-5xl mx-auto leading-relaxed drop-shadow-md font-medium tracking-normal">
        ...
        {/* About Section */}
        <section id="about" className="h-screen flex items-center justify-center px-4 py-20 bg-gray-900/40 backdrop-blur-sm snap-start snap-always">
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
                Eskrim Sanatı
              </h2>
              <p className="text-lg md:text-xl text-gray-100 leading-relaxed font-light italic tracking-wide">
            ...
            <div className="space-y-6">
              <div className="bg-blue-500/30 backdrop-blur-md rounded-lg p-6 border border-blue-400/40">
                <h3 className="text-3xl font-bold text-white mb-4 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
                  Flöre
                </h3>
              ...
              <div className="bg-purple-500/30 backdrop-blur-md rounded-lg p-6 border border-purple-400/40">
                <h3 className="text-3xl font-bold text-white mb-4 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
                  Epe
                </h3>
                <p className="text-gray-100 text-lg leading-relaxed italic">
              ...
              <div className="bg-amber-500/30 backdrop-blur-md rounded-lg p-6 border border-amber-400/40">
                <h3 className="text-3xl font-bold text-white mb-4 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
                  Kılıç
                </h3>
                <p className="text-gray-100 text-lg leading-relaxed italic">
        ...
        {/* Benefits Section */}
        <section id="benefits" className="h-screen flex items-center justify-center px-4 py-20 bg-gray-900/40 backdrop-blur-sm snap-start snap-always">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-white/10 backdrop-blur-md rounded-lg p-8 border border-white/20 text-center">
                ...
                <h3 className="text-2xl md:text-3xl font-bold text-white mb-4 tracking-wide" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
                  Zihinsel Gelişim
                </h3>
        ...
        {/* Contact Section */}
        <section id="contact" className="h-screen flex items-center justify-center px-4 py-20 bg-gray-900/40 backdrop-blur-sm snap-start snap-always">
          <div className="max-w-4xl mx-auto text-center space-y-8">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-8 tracking-wider" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
              Bize Katılın
            </h2>
            <p className="text-lg md:text-xl lg:text-2xl text-gray-200 leading-relaxed max-w-7xl mx-auto whitespace-nowrap overflow-hidden text-ellipsis font-light italic tracking-wide" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mt-12">
              <a
                ...
                className="bg-white/20 hover:bg-white/30 backdrop-blur-md px-6 py-3 rounded-lg text-white font-semibold text-sm md:text-base transition-all duration-300 border border-white/30 hover:border-white/50 w-full sm:w-48 text-center tracking-wide whitespace-nowrap"
                style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}
              >
                İletişime Geç
              </a>
        ...
        {/* Footer */}
        <footer className="fixed bottom-0 left-0 right-0 bg-gray-900/50 backdrop-blur-sm py-2 px-4 z-40">
          <div className="max-w-6xl mx-auto text-center space-y-1">
            <p className="text-gray-300 text-xs md:text-sm font-light tracking-wide" style={{ fontFamily: 'var(--font-cinzel-decorative), serif' }}>
